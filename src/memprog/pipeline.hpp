...
namespace mage::memprog {
    ...
    public:
        ...
        virtual void plan(Program<Placer>** p, std::function<void()> program) = 0;
    ...
    public:
        ...
        virtual void program(Program<BinnedPlacer>** p, std::function<void()> dsl_program, const std::string& prog_file);
        ...
        void plan(Program<BinnedPlacer>** p, std::function<void()> program) override;
